...
struct I11_AddTaskView: View {
  ...
  @State private var taskCategory: I11_Category = .general
  /// - Category Animation Properties
  @State private var animateColor: Color = I11_Category.general.color
    ...
    VStack(alignment: .leading) {
      ...
      VStack(alignment: .leading, spacing: 10) {
        ...
        LazyVGrid(columns: Array(repeating: .init(.flexible(), spacing: 20), count: 3), spacing: 15) {
          ForEach(I11_Category.allCases, id: \.rawValue) { category in
        ...
        Button {
          ...
          let task = I11_Task(dateAdded: taskDate, taskName: taskName, taskDescription: taskDescription, taskCategory: taskCategory)
          onAdd(task)
          dismiss()
        } label: {
          Text("Create Task")
...
struct I11_AddTaskView_Previews: PreviewProvider {
