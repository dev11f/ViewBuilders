...
// https://youtu.be/NkssjWSmzIg
struct I1_RollingText: View {
...
struct I1_RollingText_Previews: PreviewProvider {
    
    struct I1_ContentView: View {
        @State var value: Int = 111
        
        var body: some View {
            NavigationView {
                VStack(spacing: 25) {
                    I1_RollingText(font: .system(size: 55), weight: .black, value: $value)
