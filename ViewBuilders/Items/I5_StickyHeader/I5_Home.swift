...
//                                    .black.opacity(1)
    ...
    func AlbumView() -> some View {
        VStack(spacing: 25) {
            ForEach(I5_albums.indices, id: \.self) { index in
                HStackLayout(spacing: 25) {
                    Text("\(index + 1)")
                        .font(.callout)
                        .fontWeight(.semibold)
                        .foregroundColor(.gray)
                    ...
                    VStack(alignment: .leading, spacing: 4) {
                        Text(I5_albums[index].albumName)
                            .fontWeight(.semibold)
                            .foregroundColor(.white)
...
struct I5_Home_Previews: PreviewProvider {
